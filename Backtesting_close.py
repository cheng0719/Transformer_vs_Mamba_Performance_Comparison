...
def Backtesting():
    tsmc_data = pd.read_csv('./Datasets/tsmc_stock_prices_INT_close_only_datetime_backtesting.csv')
    ...
    transformerModel.load_weights('./Weights/transformer_close_checkpoint.weights.h5')
    mambaModel.load_weights('./Weights/mamba_close_checkpoint.weights.h5')
...
# print('TSMC 2024/2/23 Close Price Prediction: ' + str(y_real[-1]))
# print('Transformer Predicted Close Price: ' + str(transformer_pred[-1]))
# print('Mamba Predicted Close Price: ' + str(mamba_pred[-1]))
